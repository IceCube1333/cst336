...
<body>
    ...
    <h2>The Royals Gacha Banner</h2>
    <img src="photos/royalty.jpg" id="royalty">
    <h3>Roll for an opportunity to get royal loot!</h3>
    
    <form>
        <div id="buttons">
            <button type="button" class="btn btn-info" onclick="oneRollR()">1 Roll</button>
            <button type="button" class="btn btn-info" onclick="tenRollR()">10 Roll</button> <br><br>
            <span id="roll1"></span>
        </div>    
    </form>    
