...
<body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="grandheroes.php">Grand Heroes</a></li>
    ...
    <h2>Grand Heroes Gatcha Banner</h2>
    <img src="photos/grandheroes.jpg" id="gheroes">
    <h3>Roll for an opportunity to get grand loot!</h3>
